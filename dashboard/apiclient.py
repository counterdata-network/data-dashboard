...
from dashboard import FEMINICIDE_API_KEY, FEMINICIDE_API_URL
...
def _get_json(path: str) -> Dict:
    ...
    r = requests.get(
        path, params, timeout=(3.05 * 20) * 10
    )  # docs say set it to slightly larger than a multiple of 3, so 10ish minutes
    return r.json()
